...
public interface CourseDao extends JpaRepository<Course, Long> {
    ...
    Page<Course> getCoursesByStudentId(@Param("studentId") Long student_id, Pageable pageable);
    ...
    Page<Course> getNotEnrolledInCoursesByStudentId(@Param("studentId") Long student_id, Pageable pageable);
